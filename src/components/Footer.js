        ...
        <section className="footer bg-footer_bg  py-[70px] ">
            <div className='container  lg:flex  lg:justify-between lg:gap-x-4'>
                ...
                <div className=" bold text-white text-center lg:text-left flex flex-col ">
                    ...
                    <p className=' my-4 text-gray-400 sm:text-md 2xl:text-md'>There are many variations of passages of Lorem Ipsum available, but the majority have <br /> suffered alteration in some form, by injected humour.</p>
                    <form className="newletter flex flex-col items-center w-full lg:items-start ">
                        ...
                        <button className='uppercase w-[100%]  text-black bg-orange hover:bg-black hover:text-white ease-in-out duration-300 py-3 mb-8 rounded-lg lg:w-fit font-bold lg:px-8 lg:py-4'>subscribe</button>
                ...
                <div className="quick link bottom w-full max-md:py-5 md:w-[25%] ">
                    <h1 className='uppercase bold text-white  text-lg font-bold '>quick link</h1>
                    <ul className=' text-gray-400 my-4 sm:text-md 2xl:text-md flex flex-col gap-y-2 '>
                ...
                <div className=" bold text-white">
                    ...
                    <p className='text-gray-400 mb-4 w-fit lg:w-[80%] sm:text-md 2xl:text-md'><span className='hidden lg:flex'> <img src={location} alt="location-icon" className='w-fit' /> </span>Bedding Cement Works, Shoreham Road, Upper Beeding",BN44 3TX</p>
                    <p className='text-gray-400 sm:text-md 2xl:text-md  '><span className='text-orange font-bold text-md'> F: </span>01632 960177</p>
                    <p className='text-gray-400 sm:text-md 2xl:text-md  '><span className='text-orange font-bold text-md'> T:</span>+44 1632 960177</p>
                    <p className='text-gray-400 sm:text-md 2xl:text-md  '><span className='text-orange font-bold text-md'> E:</span>taiyeajimati@gmail.om</p>
                </div>
                ...
                <div className=" bold text-white mt-6 max-sm:grid col-start-1 col-end-7 gap-y-2 lg:col-start-1 lg:col-end-1 lg:mt-0">
                    ...
                    <p className='text-white pb-4'>Our support is available to help you 24/7</p>
                    <div className="moday text-gray-400 flex justify-between pb-2 border-b-[1.5px] border-gray-500">
                        ...
                        <p className='text-orange font-bold sm:text-md 2xl:text-md'> 9am - 6pm</p>
                    </div>
                    <div className="other_days text-gray-400 flex justify-between pb-2 border-b-[1.5px] border-gray-500">
                        ...
                        <p className='text-orange font-bold sm:text-md 2xl:text-md'> Closed</p>
                    </div>
                </div>
