...
function Projects() {
    ...
    return (
        <section className="project container py-20">
            <div className="heading flex justify-between items-center relative after:absolute after:left-0 after:bg-gray-300 after:right-0 after:h-[1px] after:top-12 mb-12 ">
                <h1 className='uppercase font-[700] text-[16px]'>projects</h1>
                <h1 className='bg-orange px-4 py-1 font-[500] cursor-pointer text-white rounded-xl hover:scale-[1.2] hover:bg-[#D9D8D7]
                 hover:text-orange ease-in-out duration-300 '>All</h1>
            </div>
            ...
            <div className="projects_container grid grid-cols-1 md:grid-cols-3 lg:md:grid-cols-4 xl:md:grid-cols-5 lg:gap-x-4">
                <div className="project lg:w-[200px] cursor-pointer hover:scale-[1.05] ease-in-out duration-300">
                    ...
                    <h1 className='uppercase font-[700] mt-4'>donwvalley</h1>
                ...
                <div className="project  lg:w-[200px]  cursor-pointer hover:scale-[1.05] ease-in-out duration-300">
                    ...
                    <h1 className='uppercase font-[700] mt-4'>Edward Tower</h1>
                    <p className="mb-6">There are many variations of passages of Lorem Ipsum available.</p>
                </div>
                ...
                <div className="project  lg:w-[200px]  cursor-pointer hover:scale-[1.05] ease-in-out duration-300">
                    ...
                    <h1 className='uppercase font-[700] mt-4'>Clif land HB</h1>
                    <p className="mb-6">There are many variations of passages of Lorem Ipsum available.</p>
                </div>
                ...
                <div className="project  lg:w-[200px]  cursor-pointer hover:scale-[1.05] ease-in-out duration-300">
                    ...
                    <h1 className='uppercase font-[700] mt-4'>East Side Apt.</h1>
                    <p className="mb-6">There are many variations of passages of Lorem Ipsum available.</p>
                </div>
